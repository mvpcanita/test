...
$title = $_POST['title'];
        ...
        $date = $_POST['date'];
        $time = $_POST['time'];
        $filepath="/psite/promotions/".basename($_FILES["imageInputFile"]["name"]);

        $sql = "INSERT INTO promotionstbl (title,description,`date`,time,filepath) 
        VALUES ('$title','$description','$date','$time','$filepath')";
